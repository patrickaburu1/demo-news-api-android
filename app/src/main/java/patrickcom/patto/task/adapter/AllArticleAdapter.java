...
public class AllArticleAdapter extends RecyclerView.Adapter<AllArticleAdapter.ViewHolder> {
    Context context;
    List<Article> article;
    private ImageLoader imageLoader;
    public AllArticleAdapter(List<Article> article, Context context){
        super();
    ...
    @Override
    public AllArticleAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_tech_articles, parent, false);

        AllArticleAdapter.ViewHolder viewHolder = new AllArticleAdapter.ViewHolder(v);

        return viewHolder;
    }

    @Override
    public void onBindViewHolder(AllArticleAdapter.ViewHolder holder, int position) {
